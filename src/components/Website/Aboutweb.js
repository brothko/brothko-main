      ...
      <div className="about-web-content">
        ...
        <div className="web-dev-info">
          ...
          <p className="info-text">
            Brothko creates high-quality web applications for our clients using cutting-edge techniques and technologies to provide a streamlined response to complicated business procedures.
          </p>
          <p className="info-text">
            Brothko, a professional web development company, offers custom web development solutions for changing B2C and B2B needs. We are skilled at creating robust, feature-rich websites, web apps, and web portals that provide a rich user experience. We offer cost-effective solutions for your business needs with our expertise in technologies, open-source platforms, frameworks, UI/UX design, scripting languages, DevOps services, etc.
          </p>
        ...
        <div className="mobile-dev-info">
          ...
          <h3 className="why-choose">Why Choose Brothko For Web Development?</h3>
          <ul className="services-list">
